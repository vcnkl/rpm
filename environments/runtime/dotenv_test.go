...
func TestUpsertDependencyEnvBlockDefinesReferencedVars(t *testing.T) {
...
func TestUpsertDependencyEnvBlockRemovesBlockWhenNoLongerReferenced(t *testing.T) {
	path := filepath.Join(t.TempDir(), ".env")
...
func TestUpsertDependencyEnvBlockLeavesUnreferencedFilesAlone(t *testing.T) {
	path := filepath.Join(t.TempDir(), ".env")
	body := "STATIC_VAR=value\n"
